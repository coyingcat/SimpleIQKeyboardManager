...
- (instancetype)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Copy 链接 curl" style:UIBarButtonItemStylePlain target:self action:@selector(copyButtonPressed:)];
    }
    return self;
}
