...
- (void)settingsButtonTapped:(id)sender
{
    ...
    settingsViewController.title = @"Network 网络 Debugging Settings";
...
- (NSString *)headerText{
    ...
    if ([FLEXNetworkObserver isEnabled]) {
        ...
        NSString *requestsText = totalRequests == 1 ? @"Request 请求" : @"Requests";
