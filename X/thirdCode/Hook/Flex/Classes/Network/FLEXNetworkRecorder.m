...
- (void)recordRequestWillBeSentWithRequestID:(NSString *)requestID request:(NSURLRequest *)request redirectResponse:(NSURLResponse *)redirectResponse{
    ...
    NSArray<NSString *> * dummy = @[@"dp3.qq.com", @"a.gdt.qq.com", @".umeng.com",
                                    @"aliyuncs.com", @"umsns.com"];
    NSMutableArray * hs = [NSMutableArray arrayWithArray: dummy];
    [hs addObjectsFromArray: self.hostBlacklist];
    NSArray<NSString *> * xForce = [hs copy];
    for (NSString *host in xForce) {
